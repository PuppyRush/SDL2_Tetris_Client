...
public:
    ...
    TWaitingRoomCardBuilder(const sdleasygui::GraphicInterface::window_type window, const sdleasygui::TPoint& point, const std::string& str)
        :BorderBuilder(window,point,str)
    {
    }

    TWaitingRoomCardBuilder(const sdleasygui::GraphicInterface::window_type window, sdleasygui::TPoint&& point, std::string&& str)
        :BorderBuilder(window,point,str)
    {
    }

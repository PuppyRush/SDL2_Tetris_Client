...
{
    return SEG_Rect(
        { static_cast<decltype(SEG_Rect::point.x)>(rect.x), static_cast<decltype(SEG_Rect::point.y)>(rect.y),static_cast<decltype(SEG_Rect::point.z)>(0) },
...
{
    return SEG_Rect(
        { static_cast<decltype(SEG_Rect::point::x)>(x), static_cast<decltype(SDL_Rect::point::y)>(y),static_cast<decltype(SDL_Rect::point::z)>(0) },
